...
static constexpr size_t SYMMETRIC_KEY_SIZE_BYTES	= 32; // 256 / 8 = 32
static constexpr size_t HMAC_SIZE_BYTES				= 32; // 256 / 8 = 32 
static constexpr size_t SIGNATURE_SIZE_BYTES		= 384; // 3072 / 8 = 384
static constexpr size_t DH_KEY_SIZE_BYTES			= 384; // 3072 / 8 = 384
